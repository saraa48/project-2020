...
export const getPubs = (vendeur_id, marque) => async dispatch => {
  try {
    const res = vendeur_id
      ...
      : marque
      ? // ? model
        // ? await axios.get(`/publications?marque=${marque}&model=${model}`)
...
export const updatePub = (
  ...
  try {
    // const instrument = { marque, model, logo };
...
//   try {
//     await axios.put(`/publications/like/${id}`);
//     dispatch(getPub(id));
//   } catch (error) {
//     console.log(error);
//   }
...
//   try {
//     await axios.put(`/publications/unlike/${id}`);
//     dispatch(getPub(id));
//   } catch (error) {
//     console.log(error);
//   }
