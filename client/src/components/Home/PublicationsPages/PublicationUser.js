      ...
      >
        <Row md="2" xs="1" className=" box-pub">
          <Col className="d-flex align-items-center">
            <img src={this.props.pub.image} width="70%" alt="..." />
          </Col>
          <Col>
            <h2 className="ad-title text-center our-pubs">
              {this.props.pub.title}
            </h2>
            <div className="marque-pub">
              <h4 className="our-pubs"> Marque:</h4>
              <h6 className=" secondary ml-2 mr-1">
                {this.props.pub.marque}
              </h6>
            </div>
           ...
           <p className="prixx">
            ...
            {this.props.isAuthenticated ? (
              ...
              <p className="secondary">
                ...
                <Link to="/login" className="connexion"> Se connecter</Link>
              </p>
            )}
          </Col>
        </Row>
            ...
            <ListGroupItem>
              <ListGroupItemHeading>
                <p className="connexion">
                  <span className="connexion">{this.props.pub.Comments.length}</span>{" "}
